# SDSS 3Ni EIS 1RQ Fitting

Python workflow for fitting electrochemical impedance spectroscopy (EIS) data from 3 wt.% Ni-added super duplex stainless steel using a single-time-constant equivalent circuit model.
...
This repository contains scripts and figures for 1RQ equivalent-circuit fitting of EIS spectra from 3 wt.% Ni-added SDSS conditions.
